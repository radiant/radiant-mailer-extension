...
If you use both "from:" and "from_field:" in the "mailer" part, "from_field:"
takes precedence. In that case, "from:" supplies a default sender address for
when the user leaves his or her email address blank.
